...
//struct MinScore {
//    int minimum;
//    MinScore(int min_param){
//        minimum = min_param;
//    }
//    bool operator()(int& limit) const {
...
//		auto count_100 = count(scores.begin(), scores.end(), 100);
//		cout << "This student has " << count_100 << " perfect score(s)!" << endl;
        int minimum = 90;
        auto min_score = [&] (int score) {return score >= minimum;};
        auto count_over = static_cast<int>(count_if(scores.begin(), scores.end(), min_score));
        cout << "Scores " << minimum << " or above: " << count_over << endl;
        minimum = 80;
        count_over = static_cast<int>(count_if(scores.begin(), scores.end(), min_score));
        cout << "Scores " << minimum << " or above: " << count_over << endl;
