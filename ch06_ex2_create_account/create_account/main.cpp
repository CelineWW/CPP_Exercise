...
int main()
{
    ...
    while (!valid_email) {
        ...
        // make sure email includes @
        int at_index = email.find('@');
        if (at_index == -1) {
            cout << "The email must includes at sign.\n";
            valid_email = false;
        }
        ...
        // make sure email includes special characters.
        ...
        // make sure there is at least one character between the at and last dot characters
        if (dot_index - at_index <= 1) {
            cout << "There must be at least one character between the at(@) and dot(.) sign.\n";
            valid_email = false;
        }
        // make sure there are two or three characters after the last dot character
